...
import 'package:pdf_pro/screens/pdfview.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 4), () {
      if(pdfPath != null){
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>PdfViewer(path: pdfPath)));
      }
    });
  }
    ...
    return  Scaffold(
      body: Stack(
        children: [
          ...
          //   ),
          // ),
          Image.asset('assets/splash.jpeg',fit: BoxFit.fill,height: double.infinity,)
